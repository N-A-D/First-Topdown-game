...
class Game:
    ...
    def render_current_clip(self, surface, x, y, bullets, bullet_length, bullet_height):
        ...
        :param surface: The location in which to render this information
        :param x: The x location to render
        :param y: The y location to render
        :param bullets: How many bullets to render
        ...
        if self.player.weapon != 'knife':
            temp = x
            # renders how many bullets are in the player's magazine in GOLD with the difference between
    ...
    def render_player_health(surface, x, y, pct):
        ...
        :param surface: The surface on which to render the health bar
        :param x: x location
        :param y: y location
    ...
    @staticmethod
    def render_player_stamina(surface, x, y, pct):
        """
        renders the player's stamina bar
